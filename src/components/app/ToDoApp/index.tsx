...
export default function ToDoApp(){
  const [draggingToDo, setDraggingToDo] = React.useState<DraggingTodo | null>(null);
        ...
        <DNDWrapper>
          <DraggingContext.Provider value={setDraggingToDo}>
            <div className="flex pt-10 justify-center w-screen h-screen overflow-y-auto bg-gray-100 pl-10">
              ...
              <button className='mr-10 h-10 min-w-10 border border-white-800 bg-white rounded-md  block font-bold hover:bg-slate-200' onClick={()=>appContext.createNewList("New List")}><img className="h-full" src="/images/icons/add.svg"/></button>
